										...
										<div class="d-flex justify-content-between">
											<div class="split-header">
												<img class="img-ss mt-1 mb-1 mr-2"
													src="/mstock/resources/images/social-icons/instagram.svg"
													alt="instagram">
							...
							<div class="grid">
								<div class="grid-body">
									...
									<div class="d-flex mt-5 mb-3">
										<small class="mb-0 text-primary">Recent Transaction
											(3)</small>
									</div>
						...
						<div class="col-md-8 equel-grid">
							<div class="grid">
										...
										<tbody>
											<tr>
												<td class="pr-0 pl-4"><img class="profile-img img-sm"
													src="/mstock/resources/images/profile/male/image_4.png"
											...
											<tr>
												<td class="pr-0 pl-4"><img class="profile-img img-sm"
													src="/mstock/resources/images/profile/male/image_3.png"
													alt="profile image"></td>
												<td class="pl-md-0"><small
											...
											<tr>
												<td class="pr-0 pl-4"><img class="profile-img img-sm"
													src="/mstock/resources/images/profile/female/image_2.png"
													alt="profile image"></td>
												<td class="pl-md-0"><small
											...
											<tr>
												<td class="pr-0 pl-4"><img class="profile-img img-sm"
													src="/mstock/resources/images/profile/male/image_10.png"
													alt="profile image"></td>
												<td class="pl-md-0"><small
								...
								<a class="border-top px-3 py-2 d-block text-gray" href="#">
									<small class="font-weight-medium"><i
									...
									<div class="vertical-timeline-wrapper">
										<div class="timeline-vertical dashboard-timeline">
												...
												<div class="log-details">
													...
													<div class="grouped-images mt-2">
														<img class="img-sm"
															...
															src="/mstock/resources/images/profile/male/image_5.png"
															alt="Profile Image" data-toggle="tooltip"
															title="Edward Wilson"> <img class="img-sm"
															src="/mstock/resources/images/profile/female/image_6.png"
															alt="Profile Image" data-toggle="tooltip"
															title="Billy Williams"> <img class="img-sm"
															src="/mstock/resources/images/profile/male/image_6.png"
															alt="Profile Image" data-toggle="tooltip"
															title="Lelia Hampton"> <span
															class="plus-text img-sm">+3</span>
													</div>
												</div>
											...
											<div class="activity-log">
												...
												<div class="log-details">Added new task: Slack home
													page</div>
